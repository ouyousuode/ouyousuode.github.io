...
{{page.title}}
===================================
<img src="/images/posts/2019-03-28/Emacs_over_Vim.png">
Richard的一句“I mean,why not just use Vim over Emacs(干脆连Emacs也别用，用Vim好了) ?”，直接引发程序员文本编辑器选择之战！
``` Objective-C
...
故此，掌握(Emacs)Lisp语言不仅仅是习得一门为Emacs写扩展的技艺，更多的是学习此语言表现出的世界观、扩展自己的视野范围并丰富自己的思维方式“池”。此为其二吧...
